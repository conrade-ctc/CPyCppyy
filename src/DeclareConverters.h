...
public:                                                                      \
    ...
    virtual std::string GetFailureMsg() override { return "[" #name "Converter]"; }   \
};                                                                           \
                                                                             \
...
public:                                                                      \
    bool SetArg(PyObject*, Parameter&, CallContext* = nullptr) override;      \
    PyObject* FromMemory(void*) override;                                     \
    virtual std::string GetFailureMsg() override { return "[Const" #name "RefConverter]"; }\
}
...
public:                                                                      \
    bool SetArg(PyObject*, Parameter&, CallContext* = nullptr) override;      \
    PyObject* FromMemory(void*) override;                                     \
    virtual std::string GetFailureMsg() override { return "[" #name "RefConverter]"; }\
};
...
public:                                                                      \
    ...
    virtual std::string GetFailureMsg() override { return "[" #name "ArrayConverter]"; }\
protected:                                                                   \
    dims_t fShape;                                                           \
    bool fIsFixed;                                                           \
};
...
public:
    ...
    bool HasState() override { return true; }
    virtual std::string GetFailureMsg() override { return "[CStringConverter]"; }
...
public:
    bool SetArg(PyObject*, Parameter&, CallContext* = nullptr) override;
    PyObject* FromMemory(void* address) override;
    virtual std::string GetFailureMsg() override { return "[NonConstCStringConverter]"; }
};
...
public:
    ...
    bool ToMemory(PyObject* value, void* address, PyObject* = nullptr) override;
    bool HasState() override { return true; }
    virtual std::string GetFailureMsg() override { return "[WCStringConverter]"; };
...
public:
    ...
    bool ToMemory(PyObject* value, void* address, PyObject* = nullptr) override;
    bool HasState() override { return true; }
    virtual std::string GetFailureMsg() override { return "[CString16Converter]"; };
...
public:
    ...
    bool ToMemory(PyObject* value, void* address, PyObject* = nullptr) override;
    bool HasState() override { return true; }
    virtual std::string GetFailureMsg() override { return "[CString32Converter]"; };
...
public:
    ...
    bool SetArg(PyObject*, Parameter&, CallContext* = nullptr) override;
    PyObject* FromMemory(void* address) override;
    virtual std::string GetFailureMsg() override { return "[CStringArrayConverter]"; };
...
public:
    ...
    PyObject* FromMemory(void* address) override;
    virtual std::string GetFailureMsg() override { return "[NonConstCStringArrayConverter]"; };
};
...
public:
    ...
    PyObject* FromMemory(void*) override;
    bool ToMemory(PyObject*, void*, PyObject* = nullptr) override;
    virtual std::string GetFailureMsg() override { return "[InstanceConverter]"; };
};
...
public:
    ...
    PyObject* FromMemory(void* address) override;
    bool HasState() override { return true; }
    virtual std::string GetFailureMsg() override { return "[InstanceRefConverter]"; };
...
public:
    ...
    bool SetArg(PyObject*, Parameter&, CallContext* = nullptr) override;
    virtual std::string GetFailureMsg() override { return "[InstanceMoveConverter]"; };
};
...
public:
    ...
    PyObject* FromMemory(void* address) override;
    bool ToMemory(PyObject* value, void* address, PyObject* = nullptr) override;
    virtual std::string GetFailureMsg() override { return "[InstancePtrPtrConverter]"; };
};
...
public:
    ...
    PyObject* FromMemory(void* address) override;
    bool ToMemory(PyObject* value, void* address, PyObject* = nullptr) override;
    virtual std::string GetFailureMsg() override { return "[InstanceArrayConverter]"; };
...
public:
    ...
    bool ToMemory(PyObject* value, void* address, PyObject* = nullptr) override;
    bool HasState() override { return true; }
    virtual std::string GetFailureMsg() override { return "[ComplexDConverter]"; };
...
public:
    bool SetArg(PyObject*, Parameter&, CallContext* = nullptr) override;
    virtual std::string GetFailureMsg() override { return "[STLIteratorConverter]"; };
};
...
public:
    bool SetArg(PyObject*, Parameter&, CallContext* = nullptr) override;
    virtual std::string GetFailureMsg() override { return "[VoidPtrRefConverter]"; };
};
...
public:
    ...
    PyObject* FromMemory(void* address) override;
    bool HasState() override { return true; }
    virtual std::string GetFailureMsg() override { return "[VoidPtrPtrConverter] " + fFailureMsg; }
...
public:
    bool SetArg(PyObject*, Parameter&, CallContext* = nullptr) override;
    virtual std::string GetFailureMsg() override { return "[STLStringMoveConverter]"; };
};
...
public:
    ...
    bool ToMemory(PyObject*, void*, PyObject* = nullptr) override;
    bool HasState() override { return true; }
    virtual std::string GetFailureMsg() override { return "[FunctionPointerConverter]"; };
...
public:
    ...
    PyObject* FromMemory(void* address) override;
    bool ToMemory(PyObject* value, void* address, PyObject* = nullptr) override;
    virtual std::string GetFailureMsg() override { return "[StdFunctionConverter]"; };
...
public:
    ...
    bool ToMemory(PyObject*, void*, PyObject* = nullptr) override;
    bool HasState() override { return true; }
    virtual std::string GetFailureMsg() override { return "[SmartPtrConverter]"; };
...
public:
    ...
    bool SetArg(PyObject*, Parameter&, CallContext* = nullptr) override;
    virtual std::string GetFailureMsg() override { return "[NotImplementedConverter] " + fFailureMsg; }
protected:
    const std::string fFailureMsg;
};
